 ...
 *
 */
public class ChineseActivity extends Activity implements View.OnClickListener, TextToSpeech.OnInitListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Typeface typeface = Typeface.createFromAsset(getAssets(), "light.otf");
        button1.setTypeface(typeface);

        textView = findViewById(R.id.textView);
        Typeface typeface1 = Typeface.createFromAsset(getAssets(), "honya.ttf");
    ...
    public void onInit(int status) {
        if(status == TextToSpeech.SUCCESS) {
            ...
            Locale locale = Locale.CHINESE; // 対象言語のロケール
            // ※ロケールの一覧表
